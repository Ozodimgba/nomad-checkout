import { createTransferCheckedInstruction, getAccount, getAssociatedTokenAddress, getOrCreateAssociatedTokenAccount, getMint } from '@solana/spl-token';
...
async function createSPLTokenInstruction(
    ...
    const senderATA = await getAssociatedTokenAddress(splToken, sender, allowOwnerOffCurve);
    ...
    const recipientATA = await getAssociatedTokenAddress(splToken, recipient, allowOwnerOffCurve);
